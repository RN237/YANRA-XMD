...
const sessdata = config.SESSION_ID.replace("YANRA-MD-V1~", '');
...
console.log("CONNECTING YANRA_MD-V1🧬...");
...
*╭⊱✫🐲 YANRA-MD-V1 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *YANRA-MD-V1*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *KG TECH🇨🇲*
*│✫➠ - 🌐URL:* *https://github.com/RN237/YANRA-MD-V1*
...
app.get("/", (req, res) => {
res.send("HEY, YANRA-XMD STARTED ✅");
});
